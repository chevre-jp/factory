...
export interface IStartParamsWithoutDetail
    extends AssetTransactionFactory.IStartParams<AssetTransactionType.MoneyTransfer, IAgent, IRecipient, IObjectWithoutDetail> {
    recipient: IRecipient;
}
export interface IStartParamsBeforeStart
    extends AssetTransactionFactory.IStartParams<AssetTransactionType.MoneyTransfer, IAgent, IRecipient, IObjectBeforeStart> {
    recipient: IRecipient;
}
export interface IStartParams
    extends AssetTransactionFactory.IStartParams<AssetTransactionType.MoneyTransfer, IAgent, IRecipient, IObject> {
    recipient: IRecipient;
}
